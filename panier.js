...
const panierContainerDisplay = () =>{
    ...
    if (produitLocalStorage ===null ||produitLocalStorage==0){
        ...
        for(i = 0; i<produitLocalStorage.length; i++){
            ...
            <img src="${produitLocalStorage[i].image} " alt="" class="picture3">
...
const adresseChecker = (value) => {
    ...
    if(!value.match(/^[A-Za-z0-9\s]{5,50}$/)){
        errorDisplay("adresse","L'adresse doit faire entre 5 et 50 caractères et ne doit pas contenir de caractères spéciaux");
        adresse = null;
    }else{
